...
urlpatterns = [
    ...
    path('member-query/swap/<int:congress_id>/<str:leaving_id>/<str:leaving_date>/<int:l_house>/', SQviews.swap_membership, name='swap_membership'),
    path('member-query/swap/<int:congress_id>/<str:leaving_id>/<str:leaving_date>/<int:l_house>/<str:arriving_id>/<str:arriving_date>/<str:party>/', SQviews.swap_membership, name='swap_membership'),
