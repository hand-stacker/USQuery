...
urlpatterns = [
    ...
    path('member-query/arrival/<int:congress_id>/<str:arriving_id>/<str:arriving_date>/<int:in_house>/', SQviews.update_arrival, name='update_arrival'),
    path('member-query/swap/<int:congress_id>/<str:leaving_id>/<str:leaving_date>/<int:in_house>/', SQviews.swap_membership, name='swap_membership'),
    path('member-query/swap/<int:congress_id>/<str:leaving_id>/<str:leaving_date>/<int:in_house>/<str:arriving_id>/<str:arriving_date>/<str:party>/', SQviews.swap_membership, name='swap_membership'),
