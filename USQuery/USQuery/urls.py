...
urlpatterns = [
    ...
    path('member-query/update-senators/<int:congress_id>/<str:state>/', SQviews.update_senators, name='update_senators'),
    path('member-query/update-reps/<int:congress_id>/', SQviews.update_reps, name='update_reps'),
    path('member-query/update-reps/<int:congress_id>/<str:state>/', SQviews.update_reps, name='update_reps'),
